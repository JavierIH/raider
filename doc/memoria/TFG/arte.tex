...
A continuación se realiza un repaso del estado del arte en robótica mini-humanoide. Para mayor claridad, se han desarrollado tres bloques: Plataformas robóticas, competiciones y sistemas de visión.
...
\medskip El KHR-3HV, mostrado en la figura \ref{kondo}, del fabricante japonés Kondo, es uno de los mini-humanoides mas avanzados actualmente. Puede presumir de ser el modelo de serie mas utilizado en el campeonato Robo-One, siendo seleccionado por los equipos por su gran agilidad y tamaño compacto.
...
Sin embargo, la competición CEABOT mezcla diferentes conceptos \cite{jardon2014review}. Al ser una competición multidisciplinar y completamente autónoma, los robots necesitan una versatilidad mayor. Por esta razón, un robot participante en CEABOT, y que debe realizar cuatro pruebas dentro del campeonato, no puede especializarse en una de ellas si eso supone una interferencia en su rendimiento en el resto.

\section{Locomoción}
hablar del motion, del pypose... contra analíticos un zmp y cosas asi



\section{Visión}
cmucam havimo y camaras ip
...
\medskip Una de estas opciones es el montaje de un módulo de placa y controlador integrado como la CMUcam \citep{webcmucam}. En la figura \ref{cmucam} puede observarse el módulo Pixy CMUcam5, que corresponde a la quinta iteración del diseño de la CMUcam. Este módulo se diseñó con la idea de proveer con capacidades de visión a pequeños sistema embebidos. Sólo con un microcontrolador y uno de estos módulos, pueden programarse algortimos sencillos como el tracking de objetos.
...
También existe otra posibilidad, separar la parte de visión del robot y procesarla en un sistema remoto, como un PC. Para la realización de algunos proyectos puede ser interesante el montaje de una cámara en el robot que envía las imágenes crudas a un sistema más potente y despues recibe los datos procesados. De este modo se consigue abstraer al controlador del robot del sistema de visión, mejorando su velocidad y enfocando su rendimiento en otras tareas.