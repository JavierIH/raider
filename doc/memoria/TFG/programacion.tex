...
Al igual ue en la función anterior Puede observarse que la planta del pie se eleva ligeramente. De nuevo, puede utilizarse la función \textit{movVertical} para mantener las dos plantas de los pies a la misma altura.
