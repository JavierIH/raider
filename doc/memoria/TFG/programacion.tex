...
Para la programación de la brújula se ha realizado una biblioteca, \textit{compass.h} que controla de forma sencilla la extracción de datos. Atendiendo a su manual \cite{manualcmps03}, la CMPS03 ofrece tres formas de leer su medida:
...
Se eligió conectarla por I2C por la simplicidad en su cableado. Así mismo, se ha usado el método de lectura de dos registros por su mayor precisión.
