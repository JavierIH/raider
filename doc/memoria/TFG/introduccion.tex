...
\subsection{Linea de investigación de robots Mini-Humanoides TODO}

La sección de la asociación que enmarca este trabajo es la linea de investigación de robots mini-humanoides. Los robots mini-humanoides son robots antropomórficos con una altura máxima de 50cm, tal y como indica la normativa del campeonato CEABOT ( <- TODO referencia al reglamento). De fomar orientativa, tomando como referencia la Humanoid League del campeonato RoboCup, el tamaño de los robots mini-humanoides es ligeramente inferior al de los participantes de la división "KidSize". Robots participantes de la RoboCup en la división KidSize como son el DARwIn-OP de Robotis o el Nao (figura \ref{naoydarwin}) de Aldebaran no entrarían dentro de la definición mini-humanoide, ya que sobrepasan las dimensiones máximas estipuladas.
...
TODO	 [EL OBJETIVO ES COMPETIR EN CEABOT]
