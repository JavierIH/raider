...
\medskip A día de hoy, la asociación cuenta con mas de cien miembros activos repartidos en cinco líneas de investigación independientes, como son: Vehículos Aéreos no Tripulados (UAVs), Robot Devastation, Robots Personales de Competición, Impresoras 3D Open-Source y Robots Mini-Humanoides. El grupo de mini-humanoides trabaja con pequeño robots atropomórficos destinados a la investigación y competición. En la actualidad, el proyecto MYOD \cite{webmyod} propone la construcción de robots mini-humanoides compuestos integramente con piezas impresas y replicables. Sin embargo, cabe destacar que aunque se trata de proyectos diferentes, existen grandes sinergias entre ellos. Particularmente, los miembros de la línea de Robots Mini-Humanoides, está muy ligados al estudio de las impresoras 3D, investigando diferentes técnicas de impresión, diseño de estructuras y materiales.

\section{Línea de investigación de robots Mini-Humanoides}

La sección de la asociación que enmarca este trabajo es la línea de investigación de Robots Mini-Humanoides. Los robots mini-humanoides son robots antropomórficos con una altura menor de 50cm, tal y como indica la normativa del campeonato CEABOT \cite{normativaceabot}. De foma orientativa, tomando como referencia la Humanoid League del campeonato RoboCup \cite{kitano1997robocup}, el tamaño de los robots mini-humanoides es ligeramente inferior al de los participantes de la división "KidSize". En la figura \ref{naoydarwin} aparecen dos robots de la división KidSize, como son el DARwIn-OP de Robotis \cite{darwin} o el Nao de Aldebaran \cite{gouaillier2009mechatronic}. Estos robots no entrarían dentro de la definición de mini-humanoide, ya que sobrepasan las dimensiones máximas estipuladas.
...
\medskip También se procurará que las baterías sean fácilemnte intercambiables, sin necesidad de montar y desmontar partes mecánicas. Este objetivo se propone a partir de la necesidad de hacer cambios veloces de baterías en las competiciones de mini-humanoides.
