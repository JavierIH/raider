...
\subsubsection{Sensores de luz infrarroja TODO}
...
\begin{figure}[h]
\centering
%\includegraphics[width=0.5\textwidth]{figuras/sensorir}   
...
\caption{SBC Raspberry B ©Raspberry PI Foundation.}
\label{raspberry}
\end{figure}
\FloatBarrier
...
\medskip Hoy en dia, las baterías NiMH están empezando a caer en desuso a favor de las baterías de litio. Se barajaron dos posibilidades.
...
\caption{Convertidor DC-DC comercial, UBEC ©HeliDirect.com}
\label{ubec}
\end{figure}
\FloatBarrier
