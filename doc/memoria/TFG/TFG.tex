...
%índice de figuras. También se podría hacer uno de tablas (listoftables)
\listoffigures
...
\include{linea} %Descripcion de la linea de investigacion

\include{arte} %Estado del arte
