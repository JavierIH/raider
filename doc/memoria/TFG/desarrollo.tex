...
Tras esto se ha procedido a soldar todos los componentes que necesita. En la imágen de la figura \ref{montajeplaca2} puede observarse cómo queda la placa una vez soldada. Además, se le ha realizado un lacado de seguridad con laca aislante. Esto nos ayudará a evitar posibles accidentes por contacto con conectores y partes metálicas del robot.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{figuras/montajeplaca3}   
...
\includegraphics[width=0.50\textwidth]{figuras/montajecam7} &
\includegraphics[width=0.50\textwidth]{figuras/montajecam8} \\
\end{tabular}
...
Tal y como se comentó anteriormente, se han integrado dos sensores en los brazos de RAIDER. El motivo de montarlos en los brazos es que se esta manera gozarán de mayor libertad a la hora de apuntara obstáculos. Así mismo, se ha buscado que el sensor estuviese en una posición segura, protegido ante caídas. En la figura \ref{montajeir1} se pueden observar un sensor infrarrojo alojado en su soporte, junto al resto de piezas que conforman el brazo.
...
\begin{tabular}{ >{\centering\arraybackslash}m{0.5\textwidth}
>{\centering\arraybackslash}m{0.5\textwidth}}
\includegraphics[width=0.50\textwidth]{figuras/montajeir2} &
\includegraphics[width=0.50\textwidth]{figuras/montajeir3} \\
\end{tabular}  
...
Tras estos pasos y después de montar el resto de piezas mecánicas fabricadas, el robot ya estará preparado para comenzar a desarrollar todo el software necesario.
